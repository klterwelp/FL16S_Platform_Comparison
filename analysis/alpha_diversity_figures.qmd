...
post_hoc_analysis <- median_alphas_long %>% 
  ...
  add_significance() %>%
  add_xy_position(x = "analysis", scales = "free")
...
median_alphas_long %>% 
  ...
  stat_pvalue_manual(post_hoc_analysis)

f_export_plot(plot = last_plot(), width = 8, height = 8, out_file = "alpha_diversity_metrics_1000-bootstrap-median.png")
```

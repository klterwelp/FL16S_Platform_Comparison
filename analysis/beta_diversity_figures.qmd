...
set.seed(123)
# at species level 
adonis2(formula = species_bray@dist ~ analysis + shrt_sample_dna, data = data.frame(species_bray@sam_data), permutations = 9999, by = "terms")
adonis2(formula = species_jaccard@dist ~ analysis + shrt_sample_dna, data = data.frame(species_jaccard@sam_data), permutations = 9999, by = "terms")
```

```{r}
# at genus level 
set.seed(123)
adonis2(formula = genus_bray@dist ~ analysis + shrt_sample_dna, data = data.frame(genus_bray@sam_data), permutations = 9999, by = "terms")
adonis2(formula = genus_jaccard@dist ~ analysis + shrt_sample_dna, data = data.frame(genus_jaccard@sam_data), permutations = 9999, by = "terms")
```
